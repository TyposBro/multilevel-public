    ...
    <div className="static-page-container">
      <div className="privacy-policy-content">
        ...
        <p className="body-text">
          ...
          <a href="mailto:typosbro@proton.me" className="link">
            typosbro@proton.me
          </a>
          .
        </p>
        ...
        <p className="body-text">
          <strong>
            <em>
              ...
              details about any of these topics by using our table of contents below to find the
        ...
        <h2 className="heading-1" id="infocollect">
          1. WHAT INFORMATION DO WE COLLECT?
        </h2>
        <h3 className="heading-2" id="personalinfo">
          Personal information you disclose to us
        </h3>
        <p className="body-text">
          <strong>
